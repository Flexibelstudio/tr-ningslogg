...
const VERSION = '2025-11-19-1'; // bumpa när du vill tvinga alla att uppdatera

// BUMPA dessa när du vill forcera ut ny version
const STATIC_CACHE_NAME  = 'traningslogg-static-v24';
const DYNAMIC_CACHE_NAME = 'traningslogg-dynamic-v19';
