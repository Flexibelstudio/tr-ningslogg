...
const VERSION = '2025-12-02-1'; // bumpa när du vill tvinga alla att uppdatera

// BUMPA dessa när du vill forcera ut ny version
const STATIC_CACHE_NAME  = 'traningslogg-static-v28';
const DYNAMIC_CACHE_NAME = 'traningslogg-dynamic-v23';
