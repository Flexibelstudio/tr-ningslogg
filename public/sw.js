...
const VERSION = '2025-12-12-1'; // bumpa när du vill tvinga alla att uppdatera

// BUMPA dessa när du vill forcera ut ny version
const STATIC_CACHE_NAME  = 'traningslogg-static-v29';
const DYNAMIC_CACHE_NAME = 'traningslogg-dynamic-v24';
