...
export const ClassManagementModal: React.FC<ClassManagementModalProps> = ({ 
    ...
    const { booked, waitlisted, availableSpots } = useMemo(() => {
        ...
        return { booked: b, waitlisted: w, availableSpots: spots };
    }, [classInstance]);
            ...
            <Modal isOpen={isOpen} onClose={onClose} title={modalTitle} size="2xl">
                <div className="space-y-4">
                    <div className="p-3 bg-gray-50 rounded-md border text-base">
                        ...
                        <p><strong>Status:</strong> {booked.length} / {classInstance.maxParticipants} bokade ({availableSpots} lediga)</p>
