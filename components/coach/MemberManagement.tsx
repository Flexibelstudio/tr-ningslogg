...
import { ParticipantProfile, ParticipantGoalData, ActivityLog, GeneralActivityLog, WorkoutLog } from '../../types';
...
export const MemberManagement: React.FC<MemberManagementProps> = ({ participants, setParticipants, allParticipantGoals, allActivityLogs, ai }) => {
