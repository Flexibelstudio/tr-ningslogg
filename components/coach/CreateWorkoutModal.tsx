...
import { Workout, Exercise, LiftType, WorkoutCategory, WorkoutBlock, LoggableMetric, WorkoutCategoryDefinition, ParticipantProfile, ParticipantGoalData } from '../../types';
                ...
                <div className="space-y-4">
                  {isCreatingAssigned && participantGoal && (
                      <div className="p-3 bg-violet-100 border-l-4 border-violet-500 rounded-r-lg space-y-2">
                          ...
                          {ai && (
                              <Button onClick={() => setIsAiModalOpen(true)} fullWidth size="sm" className="!mt-3">
                                  Skapa med AI-assistent
                              </Button>
                          )}
                      </div>
                  )}
