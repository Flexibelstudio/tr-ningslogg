        ...
        <>
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                ...
                >
                    ...
                    <path fillRule="evenodd" d="M9.013 15.138A5.002 5.002 0 0010 15a5 5 0 001.2-.156C10.74 16.205 9.42 17 8 17c-2.761 0-5-2.239-5-5s2.239-5 5-5c1.42 0 2.74.795 3.548 2H9.522a.5.5 0 00-.51.684l.274.965A3.504 3.504 0 016.5 10c0 .341.048.67.137.986l-.274.965A.5.5 0 006.536 12H7a1 1 0 001-1V8.5a.5.5 0 00-1 0V10a1 1 0 00-1-1H3.5a.5.5 0 000 1H5V9.5a.5.5 0 00-1 0V11a1 1 0 001 1h.027a4.98 0 001.986 3.138zM12 11.5a.5.5 0 00.51-.684l-.274-.965A3.504 3.504 0 0113.5 10c0-.341-.048-.67-.137-.986l.274-.965A.5.5 0 0013.464 8H13a1 1 0 00-1 1v2.5a.5.5 0 001 0V10a1 1 0 001-1h1.5a.5.5 0 000-1H15v1.5a.5.5 0 001 0V9a1 1 0 00-1-1h-.027a4.98 0 00-1.986-3.138C13.26 3.795 14.58 3 16 3c2.761 0 5 2.239 5 5s-2.239 5-5 5c-1.42 0-2.74-.795-3.548-2h.026z" clipRule="evenodd" />
                    </svg>
                </Button>
                )}
