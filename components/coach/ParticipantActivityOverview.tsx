    ...
    <div className="mt-10 mb-8 p-4 sm:p-6 bg-white rounded-lg shadow-xl">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 pb-4 border-b">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-800">
                Helhetsbild Aktivitet
            </h2>
            {ai && workoutLogs.length > 0 && (
                <Button onClick={generateAiSummary} disabled={isLoadingAiSummary} className="mt-3 sm:mt-0">
                    {isLoadingAiSummary ? 'Analyserar...' : 'AI Sammanfattning'}
                </Button>
            )}
        </div>
