...
import { StaffMember, Location, StaffRole } from '../../types';
...
export const AddEditStaffModal: React.FC<AddEditStaffModalProps> = ({ isOpen, onClose, onSave, staffToEdit, locations }) => {
