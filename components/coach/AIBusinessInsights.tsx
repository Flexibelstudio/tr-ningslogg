...
export const AIBusinessInsights: React.FC<AIBusinessInsightsProps> = ({
    ai, locations, participants, allActivityLogs, workouts, oneOnOneSessions, staffMembers
}) => {
...
Användarens Fråga: "${question}"`;
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-xl space-y-6">
            <div>
                <h2 className="text-3xl font-bold text-gray-800">AI Business Insights</h2>
            ...
            <Button onClick={handleGenerate} fullWidth size="md" disabled={isLoading} className="!bg-[#82c0c0] hover:!bg-[#6db5b5] !text-white">
                {isLoading ? 'Analyserar...' : 'Fråga AI'}
            </Button>
