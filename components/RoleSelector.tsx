  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 mt-2 text-2xl">Välj din roll för att fortsätta.</p>
      </div>
      <div className="bg-white p-10 rounded-xl shadow-xl w-full max-w-md space-y-6">
        <h2 className="text-4xl font-semibold text-gray-800 text-center">Jag är...</h2>
       ...
       <footer className="mt-12 text-center text-gray-500 text-base">
        Din digitala träningspartner. Powered by Flexibel Hälsostudio.
      </footer>
    </div>
  );
};