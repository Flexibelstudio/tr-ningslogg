...
import { Workout, WorkoutBlock, WorkoutCategory, Membership } from '../../types';
...
export const SelectWorkoutModal: React.FC<SelectWorkoutModalProps> = ({
  ...
  const workoutsWithRestriction = generalWorkouts.map(w => ({
      ...w,
      isRestricted: w.category !== 'Personligt program' && (membership?.restrictedCategories?.includes(w.category) || false)
  }));
