...
import { Workout, WorkoutLog, WorkoutExerciseLog, SetDetail, Exercise, WorkoutBlock, ParticipantGoalData, LoggableMetric, ParticipantProfile, UserStrengthStat, ParticipantClubMembership, IntegrationSettings, LiftType } from '../../types';
...
export const WorkoutLogForm: React.FC<WorkoutLogFormProps> = ({
  ...
  }, [isNewSession, logForReferenceOrEdit]);
            ...
            <div className="space-y-8">
              {currentGroup.exercises.map((exercise) => (
                <ExerciseLogCard 
                  ...
                  logForReferenceOrEdit={logForReferenceOrEdit}
