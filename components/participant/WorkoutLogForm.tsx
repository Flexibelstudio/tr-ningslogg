        ...
        {currentView === 'block_selection' && (
          <div className="space-y-6">
            <header className="flex justify-between items-center">
                <div>
                    <h1 className="text-4xl font-bold text-gray-800">{workout.title}</h1>
            ...
            {workout.coachNote && (
                <details className="p-4 bg-white rounded-2xl shadow-sm">
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-sm border-t">
                <Button onClick={handleAttemptFinishWorkout} fullWidth size="lg">
