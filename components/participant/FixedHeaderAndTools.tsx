  ...
  return (
    <>
      <header className="sticky top-0 z-30 bg-white shadow-md">
        ...
        <div className="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-y-2">
          ...
          <div className="flex items-center space-x-2">
            {isStaffViewingSelf ? (
                <Button onClick={onSwitchToStaffView} variant="secondary" size="sm" className="flex items-center" title="Byt till coach-vy">
                    Växla till Coachvy
                </Button>
            ) : (
      ...
      <FlowModal
        ...
        userStrengthStats={userStrengthStatsHistory}
        leaderboardSettings={leaderboardSettings}
