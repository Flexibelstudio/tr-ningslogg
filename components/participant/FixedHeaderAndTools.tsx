...
interface FixedHeaderAndToolsProps {
  ...
  onSaveProfileAndGoals: (profileData: ParticipantProfile, goalData: Omit<ParticipantGoalData, 'id' | 'participantId' | 'currentWeeklyStreak' | 'lastStreakUpdateEpochWeekId' | 'setDate'| 'isCompleted' | 'completedDate'>, markLatestGoalAsCompleted: boolean, migratedWorkoutCount?: number) => void;
      ...
      {isProfileGoalModalOpen && (
        <ProfileGoalModal
          ...
          onSave={(profileDataFromForm, goalDataFromForm, markLatestGoalAsCompleted, noGoalAdviseOptOutIgnored, migratedWorkoutCount) => {
            ...
            onSaveProfileAndGoals(newProfile, goalDataFromForm, markLatestGoalAsCompleted, migratedWorkoutCount);
