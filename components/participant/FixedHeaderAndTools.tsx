    ...
    <div className="bg-white shadow-sm border-b">
      <div className="container mx-auto px-2 py-1 flex justify-around items-center">
           <Button
            ...
            variant='ghost'
            size="sm"
            className="flex flex-col items-center h-auto p-2 text-gray-600 active:text-flexibel"
            title="Mål & Plan"
            aria-label="Mål & Plan"
          >
            <GoalIcon />
          ...
          <Button
            ...
            variant='ghost'
            size="sm"
            className="relative flex flex-col items-center h-auto p-2 text-gray-600 active:text-flexibel"
            title="Flöde"
            aria-label="Flöde"
          >
              <FlowIcon />
