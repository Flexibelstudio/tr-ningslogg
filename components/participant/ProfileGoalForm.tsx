...
interface ProfileFormProps {
  ...
  onSave: (
    profileData: { name?: string; age?: string; gender?: GenderOption; enableLeaderboardParticipation?: boolean; isSearchable?: boolean; locationId?: string; enableInBodySharing?: boolean; enableFssSharing?: boolean; }
  ) => void;
  locations: Location[];
}
    ...
    <div className="space-y-6 py-4">
      ...
      <section className="space-y-4 pt-4 border-t">
          ...
          <label className="flex items-start space-x-3 p-3 bg-gray-100 rounded-md cursor-pointer">
            ...
            <div>
                <span className="text-lg font-medium text-gray-700">
                    Visa FSS-poäng på topplistor
                </span>
                <p className="text-sm text-gray-500">
                    Tillåt att din FSS-poäng (styrkepoäng) visas på "All-Time Topplistor" som är synlig för andra medlemmar och coacher.
                </p>
            </div>
          </label>
          <label className="flex items-start space-x-3 p-3 bg-gray-100 rounded-md cursor-pointer">
