...
export const GoalForm = forwardRef<GoalFormRef, GoalFormProps>(({
  ...
  // ... (helper functions like composedGoalText, handleTargetDateChange remain same)
            ...
            <div>
                ...
                <div className="flex items-start gap-2">
                    <Textarea
                        ...
                        className="flex-grow"
                    />
                    {!showCoachFields && !hasNoSpecificGoals && (
                        <Button 
                            type="button" 
                            variant="secondary" 
                            ...
                            title={!isOnline ? "AI kräver internet" : "Förbättra målformulering med AI"}
                        >
                           {isGeneratingGoal ? "..." : "✨ SMART"}
                        </Button>
                    )}
                </div>
