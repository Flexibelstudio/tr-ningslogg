      ...
      <div className="space-y-6 pt-4">
       ...
       {flexibelStrengthScoreData && (
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="my-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
              <h5 className="font-bold mb-1">Hur hänger rekommendationerna ihop?</h5>
              <p>
                  Din <strong>Flexibel Strength Score</strong> och rådet om "fokuserad styrketräning" är en objektiv analys baserad på din styrka i förhållande till din kroppsvikt.
              </p>
              <p className="mt-2">
                  Passförslagen nedan är däremot genererade för att <strong>matcha de mål och preferenser du själv har angett</strong> i din profil, som t.ex. "gå ner i vikt" eller "bli rörligare".
              </p>
          </div>

          {flexibelStrengthScoreData.recommendations && flexibelStrengthScoreData.recommendations.length > 0 && (
            <div>
              <h5 className="text-lg font-semibold text-gray-700 mb-2">Pass som matchar dina MÅL:</h5>
