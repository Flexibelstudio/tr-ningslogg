    ...
    <nav className="bg-white shadow-lg border-b border-gray-200 sticky top-0 z-40">
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        <div className="flex items-center gap-4">
            {branding?.logoBase64 ? (
                <img src={branding.logoBase64} alt={`${currentOrganization?.name || APP_NAME} logotyp`} className="h-12 w-auto object-contain" />
            ) : (
                <img src="/icon-180x180.png" alt={APP_NAME} className="h-12 w-auto object-contain" />
            )}
