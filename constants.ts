...
export const LOCAL_STORAGE_KEYS = {
  ...
  PARTICIPANT_PHYSIQUE_HISTORY: 'flexibel_participantPhysiqueHistory',
  ...
  CONNECTIONS: 'flexibel_connections', // New for friend feature
  LAST_FLOW_VIEW_TIMESTAMP: 'flexibel_lastFlowViewTimestamp', // New for notifications
  LOCATIONS: 'flexibel_locations', // New for settings
  STAFF_MEMBERS: 'flexibel_staffMembers', // New for staff
  MEMBERSHIPS: 'flexibel_memberships', // New for memberships
  WEEKLY_HIGHLIGHT_SETTINGS: 'flexibel_weeklyHighlightSettings',
  ONE_ON_ONE_SESSIONS: 'flexibel_oneOnOneSessions',
  WORKOUT_CATEGORIES: 'flexibel_workoutCategories',
  STAFF_AVAILABILITY: 'flexibel_staffAvailability',
  INTEGRATION_SETTINGS: 'flexibel_integrationSettings',
  GROUP_CLASS_DEFINITIONS: 'flexibel_groupClassDefinitions',
  GROUP_CLASS_SCHEDULES: 'flexibel_groupClassSchedules',
  PARTICIPANT_BOOKINGS: 'flexibel_participantBookings',
};

export const PREDEFINED_GROUP_CLASSES: GroupClassDefinition[] = [
    { id: 'gc-workout-seed', name: 'Workout', defaultDurationMinutes: 45 },
    { id: 'gc-yoga-seed', name: 'Yoga', defaultDurationMinutes: 60 },
    { id: 'gc-hiit-seed', name: 'HIIT - Intervall', defaultDurationMinutes: 30 },
    { id: 'gc-ptbas-seed', name: 'PT-bas', defaultDurationMinutes: 40 },
    { id: 'gc-ptgrupp-seed', name: 'PT-grupp', defaultDurationMinutes: 60 },
    { id: 'gc-yinyoga-seed', name: 'Yin Yoga, 28°', defaultDurationMinutes: 60 },
];
...
export const PREDEFINED_WORKOUT_CATEGORIES: WorkoutCategoryDefinition[] = [
    { id: 'cat-annat-seed', name: 'Annat' },
    { id: 'cat-personligt-program-seed', name: 'Personligt program' },
    { id: 'cat-ptbas-seed', name: 'PT-bas' },
    { id: 'cat-ptgrupp-seed', name: 'PT-grupp' },
    { id: 'cat-workout-seed', name: 'Workout' },
];

export const WORKOUT_CATEGORY_OPTIONS: { value: WorkoutCategory; label: string }[] = PREDEFINED_WORKOUT_CATEGORIES.map(cat => ({
    value: cat.name,
    label: cat.name,
}));
...
export const WEIGHT_COMPARISONS: WeightComparisonItem[] = [
    { name: 'Katt', pluralName: 'Katter', weightKg: 5, emoji: '🐈' },
    { name: 'Mikrovågsugn', pluralName: 'Mikrovågsugnar', weightKg: 15, emoji: ' microwaves' },
    { name: 'Golden Retriever', pluralName: 'Golden Retrievers', weightKg: 30, emoji: '🐕' },
    { name: 'Jättesäck potatis', pluralName: 'Jättesäckar potatis', weightKg: 50, emoji: '🥔' },
    { name: 'Full öl-kagge', pluralName: 'Fulla öl-kaggar', weightKg: 60, emoji: '🍺' },
    { name: 'Varg', pluralName: 'Vargar', weightKg: 70, emoji: '🐺' },
    { name: 'Genomsnittlig man', pluralName: 'Genomsnittliga män', weightKg: 85, emoji: '👨' },
    { name: 'Gorilla', pluralName: 'Gorillor', weightKg: 160, emoji: '🦍' },
    { name: 'Lejon', pluralName: 'Lejon', weightKg: 190, emoji: '🦁' },
    { name: 'Grizzlybjörn', pluralName: 'Grizzlybjörnar', weightKg: 270, emoji: '🐻' },
    { name: 'Häst', pluralName: 'Hästar', weightKg: 400, emoji: '🐎' },
    { name: 'Isbjörn', pluralName: 'Isbjörnar', weightKg: 600, emoji: '🐻‍❄️' },
    { name: 'Personbil', pluralName: 'Personbilar', weightKg: 1500, emoji: '🚗' },
];
