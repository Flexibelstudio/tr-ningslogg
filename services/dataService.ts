...
export const createInitialOrgData = (orgId: string): OrganizationData => {
    ...
    const orgData: OrganizationData = {
        ...
        staffAvailability: [],
        integrationSettings: { enableQRCodeScanning: false, isBookingEnabled: true, bookingLeadTimeWeeks: 2, cancellationCutoffHours: 2 },
    ...
    const s2: StaffMember = { id: 'staff-2-sanna', name: 'Sanna Admin', email: 'sanna.admin@flexibel.se', role: 'Admin', locationId: loc1Id, isActive: true }; // Salem
    const s3_erik: StaffMember = { id: 'staff-3-erik', name: 'Erik Svensson (Personal)', email: 'erik@test.com', role: 'Coach', locationId: loc1Id, isActive: true }; // Salem
...
const getInitialDB = (): MockDB => {
    ...
    return {
        users: [
            ...
            { id: 'user-id-admin1', name: 'Sanna Admin', email: 'sanna.admin@flexibel.se', roles: { orgAdmin: [mainOrgId] }, linkedParticipantProfileId: 'user-id-admin1-profile' },
